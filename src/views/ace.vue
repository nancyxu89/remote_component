<template>
    <div class="ace-container">
        ...
        <div class="quick-btn" @keyup.ctrl.enter.native="doCtrlEnter">doCtrlEnter</div>
        <input @keydown.ctrl.13="doCtrlEnter">
    </div>
</template>
  ...
  mounted() {
    ...
    window.addEventListener(
      ...
      e => {
        console.log(e);
        // enter键开始
        if (e.ctrlKey && e.keyCode == 13) this.doCtrlEnter();
      },
      false
    );
  },
