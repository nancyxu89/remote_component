<template>
    <div>
        <ul>
            <li :key="item" v-for="item in list1">{{item}}</li>
        </ul>
        <ul>
            <li :key="item" v-for="item in list2">{{item}}</li>
        </ul>
        <ol>
            <li :key="item" v-for="item in list3">{{item}}</li>
        </ol>
        <ol>
            <li :key="item" v-for="item in list4">{{item}}</li>
        </ol>
        <ol>
            <li :key="item" v-for="item in list5">{{item}}</li>
        </ol>
    </div>
</template>
