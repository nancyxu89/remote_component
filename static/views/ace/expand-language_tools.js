ace.define("ace/associatecomplete",["require","exports","module","ace/autocomplete/popup","ace/lib/event","ace/lib/lang","ace/lib/dom"], function(require, exports, module) {
  "use strict";
  ...
  (function() {
    ...
    this.commands = {
      "Up": function(editor) { editor.scompleter.goTo("up"); },
      "Down": function(editor) { editor.scompleter.goTo("down"); },
      "Ctrl-Up|Ctrl-Home": function(editor) { editor.scompleter.goTo("start"); },
      "Ctrl-Down|Ctrl-End": function(editor) { editor.scompleter.goTo("end"); },

      "Esc": function(editor) { editor.scompleter.detach(); },
      "Return": function(editor) { return editor.scompleter.insertMatch(); },
      "Shift-Return": function(editor) { editor.scompleter.insertMatch(null, {deleteSuffix: true}); },
      "Tab": function(editor) {
      ...
      "PageUp": function(editor) { editor.scompleter.popup.gotoPageUp(); },
      "PageDown": function(editor) { editor.scompleter.popup.gotoPageDown(); }
    };
    ...
    this.updateCompletions = function(keepPopupPosition) {
      ...
      this.openPopup(this.editor, this.editor.scompleter.keyword, keepPopupPosition);
    };
  ...
  Associatecomplete.startCommand = {
    ...
    exec: function(editor, params) {
      debugger;
      if (!editor.scompleter)
        editor.scompleter = new Associatecomplete();
...
ace.define("ace/expand/language_tools",["require","exports","module","ace/associatecomplete","ace/config","ace/editor"], function(require, exports, module) {
  "use strict";
